    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {question.options.map((option, index) => {
          ...
          const isCorrect = showCorrectAnswer && question.correctAnswers.includes(index);
          const isWrong = showCorrectAnswer && isSelected && !question.correctAnswers.includes(index);
          const isMissed = showCorrectAnswer && !isSelected && question.correctAnswers.includes(index);
